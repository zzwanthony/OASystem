...
public class ImageCode extends ActionSupport implements ServletResponseAware {
    /**
	 * 
	 */
    ...
    public String ValiImage(){
        ...
        for (int i = 0; i < 4; i++) {
            ...
            String c = base.charAt(randNum(0, base.length()-1)) + "";
            g.drawString(c, xpyl+(i*30), ypyl);
            g.rotate(1.0*-r/180*Math.PI, xpyl+(i*30), ypyl);
            Code += c;
        }
        imageStream=convertImageToStream(img);
        session.put("Code", Code);
//        try {
//			ImageIO.write(img, "jpg", response.getOutputStream());
//		} catch (IOException e) {
//			// TODO Auto-generated catch block
//			System.out.println("图片传输出错！！！！！");
//		}
        return SUCCESS;
    }
}
